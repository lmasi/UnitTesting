...
public class CSVFormatTest {
    ...
    public static void testDelimiterSameAsCommentStartThrowsException() {
        CSVFormat.DEFAULT.withDelimiter('!').withCommentMarker('!');
    }

    @Test(expected = IllegalArgumentException.class)
    public static void testDelimiterSameAsEscapeThrowsException() {
        CSVFormat.DEFAULT.withDelimiter('!').withEscape('!');
    }

    @Test(expected = IllegalArgumentException.class)
    public static void testDuplicateHeaderElements() {
    ...
    @Test
    public static void testEqualsCommentStart() {
    ...
    @Test
    public static void testEqualsDelimiter() {
        final CSVFormat right = CSVFormat.newFormat('!');
    ...
    @Test
    public static void testEqualsEscape() {
        final CSVFormat right = CSVFormat.newFormat('\'')
                .withQuote('"')
                .withCommentMarker('#')
                .withEscape('+')
    ...
    @Test
    public static void testEqualsHeader() {
        final CSVFormat right = CSVFormat.newFormat('\'')
    ...
    @Test
    public static void testEqualsIgnoreEmptyLines() {
        final CSVFormat right = CSVFormat.newFormat('\'')
                .withCommentMarker('#')
                .withEscape('+')
                .withIgnoreEmptyLines()
    ...
    @Test
    public static void testEqualsIgnoreSurroundingSpaces() {
        final CSVFormat right = CSVFormat.newFormat('\'')
                .withCommentMarker('#')
                .withEscape('+')
                .withIgnoreSurroundingSpaces()
    ...
    @Test
    public static void testEqualsQuoteChar() {
    ...
    @Test
    public static void testEqualsQuotePolicy() {
        final CSVFormat right = CSVFormat.newFormat('\'')
                .withQuote('"')
                .withQuoteMode(QuoteMode.ALL);
        final CSVFormat left = right
    ...
    @Test
    public static void testEqualsRecordSeparator() {
        final CSVFormat right = CSVFormat.newFormat('\'')
                .withRecordSeparator(CR)
                .withCommentMarker('#')
                .withEscape('+')
    ...
    @Test
    public static void testEqualsNullString() {
        final CSVFormat right = CSVFormat.newFormat('\'')
                .withRecordSeparator(CR)
                .withCommentMarker('#')
                .withEscape('+')
    ...
    @Test
    public static void testEqualsSkipHeaderRecord() {
        final CSVFormat right = CSVFormat.newFormat('\'')
                .withRecordSeparator(CR)
                .withCommentMarker('#')
                .withEscape('+')
    ...
    @Test(expected = IllegalArgumentException.class)
    public static void testEscapeSameAsCommentStartThrowsException() {
        CSVFormat.DEFAULT.withEscape('!').withCommentMarker('!');
    }

    @Test(expected = IllegalArgumentException.class)
    public static void testEscapeSameAsCommentStartThrowsExceptionForWrapperType() {
    ...
    @Test
    public static void testGetHeader() throws Exception {
    ...
    @Test
    public static void testNullRecordSeparatorCsv106() {
    ...
    @Test(expected = IllegalArgumentException.class)
    public static void testQuoteCharSameAsCommentStartThrowsException() {
        CSVFormat.DEFAULT.withQuote('!').withCommentMarker('!');
    }

    @Test(expected = IllegalArgumentException.class)
    public static void testQuoteCharSameAsCommentStartThrowsExceptionForWrapperType() {
        // Cannot assume that callers won't use different Character objects
        CSVFormat.DEFAULT.withQuote(new Character('!')).withCommentMarker('!');
    }

    @Test(expected = IllegalArgumentException.class)
    public static void testQuoteCharSameAsDelimiterThrowsException() {
        CSVFormat.DEFAULT.withQuote('!').withDelimiter('!');
    }

    @Test(expected = IllegalArgumentException.class)
    public static void testQuotePolicyNoneWithoutEscapeThrowsException() {
        CSVFormat.newFormat('!').withQuoteMode(QuoteMode.NONE);
    }

    @Test
    public static void testRFC4180() {
    ...
    @Test
    public static void testWithCommentStart() throws Exception {
    ...
    @Test(expected = IllegalArgumentException.class)
    public static void testWithCommentStartCRThrowsException() {
        CSVFormat.DEFAULT.withCommentMarker(CR);
    }

    @Test
    public static void testWithDelimiter() throws Exception {
        final CSVFormat formatWithDelimiter = CSVFormat.DEFAULT.withDelimiter('!');
        assertEquals('!', formatWithDelimiter.getDelimiter());
    }

    @Test(expected = IllegalArgumentException.class)
    public static void testWithDelimiterLFThrowsException() {
        CSVFormat.DEFAULT.withDelimiter(LF);
    }

    @Test
    public static void testWithEscape() throws Exception {
    ...
    @Test(expected = IllegalArgumentException.class)
    public static void testWithEscapeCRThrowsExceptions() {
        CSVFormat.DEFAULT.withEscape(CR);
    }

    @Test
    public static void testWithHeader() throws Exception {
        final String[] header = new String[]{"one", "two", "three"};
    ...
    @Test
    public static void testWithHeaderEnum() throws Exception {
    ...
    @Test
    public static void testWithEmptyEnum() throws Exception {
    ...
    @Test(expected = IllegalArgumentException.class)
    public static void testWithQuoteLFThrowsException() {
        CSVFormat.DEFAULT.withQuote(LF);
    }

    @Test
    public static void testWithQuotePolicy() throws Exception {
    ...
    @Test
    public static void testWithRecordSeparatorCR() throws Exception {
    ...
    @Test
    public static void testWithRecordSeparatorLF() throws Exception {
    ...
    @Test
    public static void testWithRecordSeparatorCRLF() throws Exception {
        final CSVFormat formatWithRecordSeparator = CSVFormat.DEFAULT.withRecordSeparator(CRLF);
        assertEquals(CRLF, formatWithRecordSeparator.getRecordSeparator());
    }

    @Test
    public static void testWithFirstRecordAsHeader() throws Exception {
